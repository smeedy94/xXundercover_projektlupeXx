APP.zoom2_person_mpde_cl = Class.create({
//------------------------------------------------------------------------------
   initialize: function () {
      this.data_o =APP.db_o.execute_px("GET","data/person.json");
      if (this.data_o == null)
        this.data_o = {};
    },
  ...
  updateBox:function(id, conf){
    ...
    this.data_o[id]['alter'] = conf[1]['value'];
    this.data_o[id]['position'] = conf[2]['value'];
