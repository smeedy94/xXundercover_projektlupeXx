...
//------------------------------------------------------------------------------
   ...
   render_px: function (data_opl) {
       ...
       this.canvas.scenes.create("Zoom0",function(){
            this.canvas.scenes.add(this.loadBox());
       })
   ...
   loadBox:function(){
      ...
      for (var x in data){
         var box = this.canvas.Zoom0.display.rectangle(data[x]);
         var text = this.canvas.Zoom0.text( data[x].text_o );
